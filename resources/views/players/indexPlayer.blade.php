                ...
                <table class="min-w-full">
                    ...
                    <tbody class="bg-gray-100 hover:bg-orange-300">
                        <tr>
                            ...
                            <!-- club -->
                            <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap border-b border-gray-200 text-orange-400">
                                <div class="text-sm leading-5 text-gray-900"><a href={{ route('players.show', $player->club->name) }}>{{ $player->club ? $player->club->name : '-' }}</a></div>
                            </td>   
                            <td class="px-6 py-4 text-sm leading-5 whitespace-no-wrap border-b border-gray-200 text-orange-400">
                                <div class="text-sm text-left leading-5 text-gray-900"><a href={{ route('players.show', $player->id) }}>(id {{ $player->id_club }})</a></div>
                            </td>

                            <!-- actions -->
                            <td class="text-xs font-medium leading-5 whitespace-no-wrap border-b border-gray-200">
                                <a href="{{ route('players.edit', $player->id) }}" class="text-indigo-600 hover:text-indigo-900">
                            ...
                            <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                <a href="{{ route('players.show', $player->id) }}" class="text-gray-600 hover:text-gray-900">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
